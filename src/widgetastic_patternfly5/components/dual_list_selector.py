...
class BaseDualListSelector:
    """Represents the Patternfly 5 Dual list selector.

    https://www.patternfly.org/components/dual-list-selector
    """
    ...
    SECTION_TITLE = ".//div[contains(@class, 'dual-list-selector__title-text')]"
